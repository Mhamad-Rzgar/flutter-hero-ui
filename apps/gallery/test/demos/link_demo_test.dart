...
import 'package:hero_ui_gallery/src/demos/link_demo.dart';
import 'package:hero_ui_gallery/src/pages/component_page.dart';

void main() {
  testWidgets('link demo renders the playground and every example', (
    WidgetTester tester,
  ) async {
    tester.view.physicalSize = const Size(390, 6000);
    tester.view.devicePixelRatio = 1;
    addTearDown(tester.view.reset);
    final ComponentDemo demo = linkDemo;
    ...
    expect(find.byType(HeroLink), findsWidgets);
    for (final DemoExample example in demo.examples) {
