...
import 'package:hero_ui_gallery/src/demos/typography_demo.dart';
import 'package:hero_ui_gallery/src/pages/component_page.dart';

void main() {
  testWidgets('typography demo renders the playground and every example', (
    WidgetTester tester,
  ) async {
    tester.view.physicalSize = const Size(390, 6000);
    tester.view.devicePixelRatio = 1;
    addTearDown(tester.view.reset);
    final ComponentDemo demo = typographyDemo;
    ...
    expect(find.byType(HeroText), findsWidgets);
    for (final DemoExample example in demo.examples) {
