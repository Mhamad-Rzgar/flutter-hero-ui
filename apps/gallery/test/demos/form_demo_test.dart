...
import 'package:hero_ui_gallery/src/demos/form_demo.dart';

void main() {
  testWidgets('form demo examples build', (WidgetTester tester) async {
    tester.view.physicalSize = const Size(390, 844);
    tester.view.devicePixelRatio = 1;
    addTearDown(tester.view.reset);
    final ComponentDemo demo = formDemo;
    ...
    expect(find.byType(HeroForm), findsWidgets);
  });
}
