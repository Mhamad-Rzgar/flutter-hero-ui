...
import 'package:hero_ui_gallery/src/demos/label_demo.dart';

void main() {
  testWidgets('label demo examples build', (WidgetTester tester) async {
    tester.view.physicalSize = const Size(390, 844);
    tester.view.devicePixelRatio = 1;
    addTearDown(tester.view.reset);
    final ComponentDemo demo = labelDemo;
    ...
    expect(find.byType(HeroLabel), findsWidgets);
  });
}
