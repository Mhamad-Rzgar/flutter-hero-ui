...
import 'package:hero_ui_gallery/src/demos/color_area_demo.dart';
import 'package:hero_ui_gallery/src/pages/component_page.dart';

void main() {
  testWidgets('color area demo renders the playground and every example', (
    WidgetTester tester,
  ) async {
    tester.view.physicalSize = const Size(390, 4000);
    tester.view.devicePixelRatio = 1;
    addTearDown(tester.view.reset);
    final ComponentDemo demo = colorAreaDemo;
    ...
    expect(find.byType(HeroColorArea), findsWidgets);
    ...
    expect(
      find.text('Current color: #9B80FF', findRichText: true),
      findsOneWidget,
    );
    for (final DemoExample example in demo.examples) {
