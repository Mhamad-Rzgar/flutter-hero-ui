...
import 'package:hero_ui_gallery/src/demos/fieldset_demo.dart';

void main() {
  testWidgets('fieldset demo examples build', (WidgetTester tester) async {
    tester.view.physicalSize = const Size(390, 844);
    tester.view.devicePixelRatio = 1;
    addTearDown(tester.view.reset);
    final ComponentDemo demo = fieldsetDemo;
    ...
    expect(find.byType(HeroFieldset), findsWidgets);
  });
}
