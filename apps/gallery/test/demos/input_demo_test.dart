...
import 'package:hero_ui_gallery/src/demos/input_demo.dart';

void main() {
  testWidgets('input demo examples build', (WidgetTester tester) async {
    ...
    expect(find.byType(HeroInput), findsWidgets);
  });
}
